...
For a more detailed description of the thirst system, check out the [Hydration Wiki](https://github.com/skypixel-development/SurvivalPlus/wiki/Hydration)
...
For a more detailed explanation of the energy system, check out the [Energy Wiki](https://github.com/skypixel-development/SurvivalPlus/wiki/Energy)
